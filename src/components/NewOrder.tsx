...
export default function NewOrder() {
  ...
  const handleSubmitOrder = () => {
    ...
    const kot = {
      ...
      orderId: newOrder.id,
      orderNumber,
      tableNumber: orderType === 'dine-in' ? state.tables.find(t => t.id === selectedTable)?.number : undefined,
      type: orderType,
      items: orderItems,
      createdAt: new Date(),
      status: 'pending' as const,
    ...
    // Set current order and KOT for printing
    ...
    // Show success message and print options

...
export default function Orders() {
  ...
  const todayRevenue = state.orders
    .filter(o => format(o.createdAt, 'yyyy-MM-dd') === format(new Date(), 'yyyy-MM-dd'))
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-emerald-600">${todayRevenue.toFixed(2)}</p>
            </div>
                ...
                return (
                  <tr key={order.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">
                        Updated: {format(order.updatedAt, 'HH:mm')}
                      </div>
                    </td>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p><span className="text-gray-500">Created:</span> {format(selectedOrder.createdAt, 'MMM dd, yyyy HH:mm')}</p>
                  </div>
                </div>
                <div>

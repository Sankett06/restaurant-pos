      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 w-full max-w-md">
        ...
        <div className="mt-6 sm:mt-8 p-3 sm:p-4 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-1 text-xs text-gray-500">
            <p>Super Admin: superadmin@restaurantpos.com / superadmin123</p>
            <p>Admin: admin@grandbistro.com / admin123</p>
            <p>Manager: manager@grandbistro.com / manager123</p>
            <p>Staff: staff@grandbistro.com / staff123</p>
          </div>
        </div>
      </div>
    </div>
